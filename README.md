...
- Raw Python replay semantics:
  [`agentposix/docs/adapters/raw-python.md`](agentposix/docs/adapters/raw-python.md)
- Adapter extension contract:
  [`agentposix/docs/adapters/extension-contract.md`](agentposix/docs/adapters/extension-contract.md)
...
The implementation and hardening plan is tracked in:

- [`agent_posix_implementation_blueprint.md`](agent_posix_implementation_blueprint.md)
- [`agent_posix_production_readiness_blueprint.md`](agent_posix_production_readiness_blueprint.md)
